...
public class VideoFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        videoRv.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onRefresh() {
                NetWork.getVideo(new Observer<TouBean>() {
                    ...
                    public void onNext(TouBean touBean) {
                        hits.add(0,touBean.getData().get(0).getDisplay().getHits().get(4));
                        setDataAdapter(hits);
                        videoRv.refreshComplete();
                    }
                });
            ...
            public void onLoadMore() {
                ...
                NetWork.getVideo(new Observer<TouBean>() {
                    ...
                    @Override
                    public void onNext(TouBean touBean) {
                        hits.add(touBean.getData().get(0).getDisplay().getHits().get(0));
                        videoRv.refreshComplete();
    ...
    protected void initData(final StateView mStateView) {
        ...
        NetWork.getVideo(new Observer<TouBean>() {
            ...
            public void onNext(TouBean touBean) {
                ...
                hits = touBean.getData().get(0).getDisplay().getHits();
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private void setDataAdapter(List<Hits> videoList) {
